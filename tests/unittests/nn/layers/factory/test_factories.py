...
def test_get_conv_layer():
    from clinicadl.old_network.nn.layers.factory import get_conv_layer
...
def test_get_norm_layer():
    from clinicadl.old_network.nn.layers.factory import get_norm_layer
...
def test_get_pool_layer():
    from clinicadl.old_network.nn.layers import PadMaxPool3d
    from clinicadl.old_network.nn.layers.factory import get_pool_layer
