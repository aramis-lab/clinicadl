...
def test_UNetDown(input_3d):
    from clinicadl.networks.old_network.nn.blocks import UNetDown
...
def test_UNetUp(input_3d, skip_input):
    from clinicadl.networks.old_network.nn.blocks import UNetUp
...
def test_UNetFinalLayer(input_3d, skip_input):
    from clinicadl.networks.old_network.nn.blocks import UNetFinalLayer
