...
def test_UNetDown(input_3d):
    from clinicadl.old_network.nn.blocks import UNetDown
...
def test_UNetUp(input_3d, skip_input):
    from clinicadl.old_network.nn.blocks import UNetUp
...
def test_UNetFinalLayer(input_3d, skip_input):
    from clinicadl.old_network.nn.blocks import UNetFinalLayer
