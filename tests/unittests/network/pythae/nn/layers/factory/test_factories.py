...
def test_get_conv_layer():
    from clinicadl.network.pythae.nn.layers.factory import get_conv_layer
...
def test_get_conv_layer():
    from clinicadl.network.pythae.nn.layers.factory import get_norm_layer
...
def test_get_conv_layer():
    from clinicadl.network.pythae.nn.layers import PadMaxPool3d
    from clinicadl.network.pythae.nn.layers.factory import get_pool_layer
