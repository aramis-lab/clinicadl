...
@pytest.mark.parametrize("network_name,params", [
    ("AutoEncoder", {"spatial_dims": 3, "in_channels": 1, "out_channels": 1, "channels": [2, 2], "strides": [1, 1]}),
    ("VarAutoEncoder", {"spatial_dims": 3, "in_shape": (1, 16, 16, 16), "out_channels": 1, "latent_size": 16, "channels": [2, 2], "strides": [1, 1]}),
    ("Regressor", {"in_shape": (1, 16, 16, 16), "out_shape": (1, 16, 16, 16), "channels": [2, 2], "strides": [1, 1]}),
    ("Classifier", {"in_shape": (1, 16, 16, 16), "classes": 2, "channels": [2, 2], "strides": [1, 1]}),
    ("Discriminator", {"in_shape": (1, 16, 16, 16), "channels": [2, 2], "strides": [1, 1]}),
    ("Critic", {"in_shape": (1, 16, 16, 16), "channels": [2, 2], "strides": [1, 1]}),
    ("DenseNet", {"spatial_dims": 3, "in_channels": 1, "out_channels": 1}),
    ("FullyConnectedNet", {"in_channels": 3, "out_channels": 1, "hidden_channels": [2, 3]}),
    ("VarFullyConnectedNet", {"in_channels": 1, "out_channels": 1, "latent_size": 16, "encode_channels": [2, 2], "decode_channels": [2, 2]}),
    ("Generator", {"latent_shape": (3,), "start_shape": (1, 16, 16, 16), "channels": [2, 2], "strides": [1, 1]}),

    ("ResNet", {"block": "bottleneck", "layers": (4, 4, 4, 4), "block_inplanes": (5, 5, 5, 5), "spatial_dims": 2}),

    ("ResNetFeatures", {"model_name": "resnet10"}),
    ("SegResNet", {}),
    ("UNet", {"spatial_dims": 3, "in_channels": 1, "out_channels": 1, "channels": [2, 2, 2], "strides": [1, 1]}),
    ("AttentionUnet", {"spatial_dims": 3, "in_channels": 1, "out_channels": 1, "channels": [2, 2, 2], "strides": [1, 1]}),
