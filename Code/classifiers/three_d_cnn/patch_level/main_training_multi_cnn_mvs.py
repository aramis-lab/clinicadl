...
model = eval('Conv_4_FC_2')()
output_dir = '/network/lustre/dtlake01/aramis/projects/clinica/CLINICA_datasets/CAPS/Frontiers_DL/Experiments_results/AD_CN/3d_patch/AD_CN/longitudinal/final_results/pytorch_AE_Conv_4_FC_2_bs32_lr_e5_only_finetuning_epoch20_ps_50_ss_50_baseline_all_patch_backup_multiCNN'
num_cnn = 36
fi = 4
