...
parser.add_argument("--input_dir", type=str, default='/teams/ARAMIS/PROJECTS/CLINICA/CLINICA_datasets/temp/CAPS_ADNI_DL',
                    help="Path to input dir of the MRI (preprocessed CAPS_dir).")
parser.add_argument("--model", type=str, default='Conv5_FC3', choices=["Conv5_FC3"],
                    help="model selected")
