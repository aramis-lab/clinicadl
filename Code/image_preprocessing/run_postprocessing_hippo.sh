...
#SBATCH --output=/network/lustre/iss01/home/junhao.wen/working_dir/pytorch/logs/image_postprocessing_hippo_%j.out
#SBATCH --error=/network/lustre/iss01/home/junhao.wen/working_dir/pytorch/logs/image_postprocessing_hippo_%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=junhao.wen@icm-institute.org
#SBATCH --job-name="image postprocessing extract hippo"
