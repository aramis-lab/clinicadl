...
class BidsLikeDatasetConfig(ObjectConfig["BidsLikeDataset"]):
    """Config class to check ``BidsLikeDataset`` inputs."""
...
class BidsLikeDataset(HasConfig[BidsLikeDatasetConfig], SamplerDataset):
    """
    Abstract class with the common logic of all the :py:class:` ~clinicadl.data.datasets.Dataset`
    that work with BIDS, BIDS derivatives or CAPS.
    """
