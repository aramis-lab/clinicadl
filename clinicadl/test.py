...
merged_tsv = "/Users/camille.brianceau/Downloads/merged_final.tsv"

data_tsv = "/Users/camille.brianceau/aramis/test_ravi_qc/labels.tsv"

result_tsv = "/Users/camille.brianceau/aramis/clinicadl/clinicadl/test_fin.tsv"

list_diag = ["AD", "CN"]


demographics_analysis(Path(merged_tsv), Path(data_tsv), Path(result_tsv), list_diag)
