...
class RandomMotion(object):
    ...
    def __init__(
        self,
        translation: Tuple[int, int] = (2, 4),
        rotation: Tuple[int, int] = (2, 4),
...
class RandomGhosting(object):
    ...
    def __init__(self, num_ghosts: Tuple[int, int] = (4, 10)):
...
class RandomSpike(object):
    ...
    def __init__(self, num_spikes: int = 1, intensity: Tuple[int, int] = (1, 3)):
...
class RandomBiasField(object):
    ...
    def __init__(self, coefficients: float = 0.5):
...
class RandomBlur(object):
    ...
    def __init__(self, std: Tuple[int] = (0, 2)):
        self.std = std
...
class RandomSwap(object):
    ...
    def __init__(self, patch_size: int = 15, num_iterations: int = 100):
...
class SizeReduction(object):
    ...
    def __init__(self, size_reduction_factor: int = 2) -> None:
