...
#SBATCH --ntasks=1
#SBATCH --workdir=/gpfswork/rech/zft/upd53tc/jobs/AD-DL/evaluation/slice
#SBATCH --output=./test13/pytorch_job_%j.out
#SBATCH --error=./test13/pytorch_job_%j.err
...
GPU=1
NUM_WORKERS=8
OUTPUTDIR="slice2D_model-resnet18_preprocessing-linear_task-AD-CN_baseline-1_preparedl-1_splits-5"

TSVPATH="$HOME/code/AD-DL/data/$COHORT/lists_by_diagnosis/test/"
RESULTSPATH="$SCRATCH/results/3_test/test13/$OUTPUTDIR/"
