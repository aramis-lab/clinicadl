...
#SBATCH --nodes=1
#SBATCH --chdir=.
#SBATCH --output=logs/exp3/pytorch_job_%j.out
#SBATCH --error=logs/exp3/pytorch_job_%j.err
...
# Pretraining
T_BOOL=1
T_PATH="reproducibility_results/model-Conv5_FC3_preprocessing-linear_task-autoencoder_baseline-1_norm-1_splits-5"
