...
#SBATCH --nodes=1
#SBATCH --chdir=.
#SBATCH --output=logs/exp6/pytorch_job_%j.out
#SBATCH --error=logs/exp6/pytorch_job_%j.err
...
# Pretraining
T_BOOL=1
T_PATH="reproducibility_results/model-Conv5_FC3_preprocessing-linear_task-AD_CN_norm-1_splits-5"
