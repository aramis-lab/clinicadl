...
extract_json = click.option(
    "-ej",
    "--extract_json",
    type=get_type("extract_json", BaseExtraction),
    default=get_default("extract_json", BaseExtraction),
...
patch_size = click.option(
    "-ps",
    "--patch_size",
    type=get_type("patch_size", Patch),
    default=get_default("patch_size", Patch),
    show_default=True,
    help="Patch size.",
)
stride_size = click.option(
    "-ss",
    "--stride_size",
    type=get_type("stride_size", Patch),
    default=get_default("stride_size", Patch),
    show_default=True,
    help="Stride size.",
)
...
slice_direction = click.option(
    "-sd",
    "--slice_direction",
    type=get_type("slice_direction", Slice),
    default=get_default("slice_direction", Slice),
    show_default=True,
...
slice_mode = click.option(
    "-sm",
    "--slice_mode",
    type=get_type("slice_mode", Slice),
    default=get_default("slice_mode", Slice),
    show_default=True,
    help=(
...
discarded_slices = click.option(
    "-ds",
    "--discarded_slices",
    type=get_type("discarded_slices", Slice),
    default=get_default("discarded_slices", Slice),
    multiple=2,
...
roi_list = click.option(
    "--roi_list",
    type=get_type("roi_list", ROI),
    default=get_default("roi_list", ROI),
    required=True,
    multiple=True,
...
roi_uncrop_output = click.option(
    "--roi_uncrop_output",
    type=get_type("roi_uncrop_output", ROI),
    default=get_default("roi_uncrop_output", ROI),
    is_flag=True,
...
roi_custom_template = click.option(
    "--roi_custom_template",
    "-ct",
    type=get_type("roi_custom_template", ROI),
    default=get_default("roi_custom_template", ROI),
...
roi_custom_mask_pattern = click.option(
    ...
    "-cmp",
    type=get_type("roi_custom_mask_pattern", ROI),
    default=get_default("roi_custom_mask_pattern", ROI),
