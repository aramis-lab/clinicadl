...
preprocessing_json = click.option(
    "-ej",
    "--preprocessing_json",
    type=get_type("preprocessing_json", ExtractionConfig),
    default=get_default("preprocessing_json", ExtractionConfig),
...
preprocessing = click.option(
    "--preprocessing",
    type=get_type("preprocessing", ExtractionConfig),
    default=get_default("preprocessing", ExtractionConfig),
    required=True,
