...
def quality_check(caps_dir, output_dir, group_label):
    ...
    print(
        "Number of sessions removed based on max intensity: %i"
    ...
    print(
        "Number of sessions removed based on non-zero voxels: %i"
    ...
    print(
        "Number of sessions removed based on frontal similarity with DARTEL template: %i"
