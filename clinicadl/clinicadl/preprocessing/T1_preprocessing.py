...
def preprocessing_t1w(bids_directory, 
    ...
    import tempfile
    from .T1_preprocessing_utils import (get_subid_sesid_datasink, 
            bids_datagrabber_t1w, crop_nifti, rename_file, 
            ants_registration_syn_quick, 
            ants_histogram_intensity_normalization) 
    ...
    inputnode = npe.Node(
            nutil.IdentityInterface(fields=['bids_directory', 'tsv']),
            name='inputnode'
            )
    ...
    antsRegistrationSyNQuick = npe.MapNode(
            ...
            interface=nutil.Function(
                ...
                output_names=[
                    'image_warped', 'affine_matrix', 'warp',
    ...
    get_identifiers = npe.MapNode(
            nutil.Function(
                input_names=['participant_id', 'session_id', 'caps_directory'], 
                output_names=[
