...
parser.add_argument(
    "input_dir", type=str, help="Path to input dir of the MRI (preprocessed CAPS_dir)."
)
parser.add_argument("output_dir", type=str, help="Path to the outputs directory.")
...
def main(options):
    ...
    splits_indices, diagnosis_tsv = extract_indices_from_5_fold(
    ...
    wf = VB_KFold_DualSVM(
        ...
        "T1",
        options.output_dir,
        n_threads=options.num_workers,
        n_folds=options.n_splits,
