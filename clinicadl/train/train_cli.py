...
from .tasks.classification import cli as classification_cli
from .tasks.reconstruction import cli as reconstruction_cli
from .tasks.regression import cli as regression_cli
