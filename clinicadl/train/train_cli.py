...
from .tasks.classification.classification_cli import cli as classification_cli
from .tasks.reconstruction.reconstruction_cli import cli as reconstruction_cli
from .tasks.regression.regression_cli import cli as regression_cli
