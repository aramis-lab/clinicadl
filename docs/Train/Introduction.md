...
- **Computational resources**
    ...
    - `--zero/--no-zero` (bool) Enables Zero Redundancy Optimizer with Pytorch to save memory at the cost of communications. Requires using multiple GPUs Default: `False`.
