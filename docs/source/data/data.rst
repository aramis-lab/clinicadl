...
:ref:`caps_datasets`, which is a PyTorch `dataset <https://pytorch.org/tutorials/beginner/basics/data_tutorial.html>`_
...
representation of these data. ``CapsDataset`` will use that object to get the
