...
`ClinicaDL project <https://github.com/aramis-lab/clinicadl>`_. As it is a beta version,
you are strongly encouraged to contribute. We thus suggest that you install
