...
Three types of tensors are proposed: 3D images, 3D patches, 3D regions or 2D slices.
...
## Prerequisites
You will need to execute the preprocessing pipeline corresponding to the `modality`
