...
#SBATCH --output=./test11_singleCNN_job_%j.out
#SBATCH --error=./test11_singleCNN_job_%j.err
...
SCRIPT="evaluation_singleCNN.py"
SELECTION="best_acc"
...
OUTPUTDIR="patch3D_model-Conv4_FC3_preprocessing-linear_task-autoencoder_baseline-0_norm-1_splits-5"
