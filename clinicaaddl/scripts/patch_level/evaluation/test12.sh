...
#SBATCH --output=./test12/pytorch_job_%j.out
#SBATCH --error=./test12/pytorch_job_%j.err
#SBATCH --job-name=test12_patch
#SBATCH --gres=gpu:1
...
OUTPUTDIR="patch3D_model-Conv4_FC3_preprocessing-linear_task-sMCI_pMCI_baseline-0_norm-1_t-1_multi-cnn_splits-5"

TSVPATH="$HOME/code/AD-DL/data/$COHORT/lists_by_diagnosis/test/"
RESULTSPATH="$SCRATCH/results/3_test/test12/$OUTPUTDIR/"
