...
# Pretraining
T_BOOL=1
T_PATH="reproducibility_results/model-Conv5_FC3_preprocessing-linear_task-autoencoder_baseline-1_norm-1_t-0_splits-5"
...
IMGPATH="/network/lustre/dtlake01/aramis/users/clinica/CLINICA_datasets/CAPS/Frontiers_DL/$COHORT"
