...
def parse_command_line():
    ...
    subparser = parser.add_subparsers(
        title='''Task to execute with clinicaaddl:''',
        description='''What kind of task do you want to use with clinicaaddl?
            (tsvtool, preprocessing, generate, train, classify).''',
        dest='task',
        help='''****** Tasks proposed by clinicaaddl ******''')
    ...
    generate_subparser = generate_parser.add_subparsers(
        ...
        description='''What type of synthetic data do you want to generate?
                (random, trivial).''',
        dest='mode',
        help='''****** Synthetic datasets proposed by clinicaaddl ******''')
    ...
    preprocessing_subparser = preprocessing_parser.add_subparsers(
        title='''Preprocessing task to execute with clinicaaddl:''',
        description='''What kind of task do you want to perform with clinicaaddl?
    ...
    tsv_subparser = tsv_parser.add_subparsers(
        ...
        dest='tsv_task',
        help='''****** Tasks proposed by clinicaaddl tsv tool ******''')
    ...
    tsv_split_subparser.add_argument(
        "formatted_data_path",
        help="Path to the folder containing data extracted by clinicaaddl tsvtool getlabels.",
        type=str)
    ...
    interpret_subparser = interpret_parser.add_subparsers(
        ...
        dest='task',
        help='''****** Saliency maps proposed by clinicaaddl ******'''
    )
